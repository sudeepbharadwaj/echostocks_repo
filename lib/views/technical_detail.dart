...
class techDetail extends StatefulWidget {
  ...
  int index;
  techDetail({Key? key, required this.index}) : super(key: key);
  

  @override
  // ignore: no_logic_in_create_state
  _techDetailState createState() => _techDetailState(index);
}
       ...
       minimum: EdgeInsets.only(left:3.w,right:2.5.w),
        ...
        child:Visibility(visible:_isloading,replacement: const  Center(child: CircularProgressIndicator(color:Colors.white10),),
          child: SingleChildScrollView(
            ...
            child:
            (_helper.getdatawbykey2(_helper.getdatawbykey2("ID")[index])["Description"]!=null)?
            Column(
               ...
               Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text("Technical",style: GoogleFonts.poppins(fontSize:14.sp,fontWeight: FontWeight.w600,color:Colors.white,letterSpacing: 1.6),))
                  ],
                ),
                Html(data: _techdata,
                style:{
